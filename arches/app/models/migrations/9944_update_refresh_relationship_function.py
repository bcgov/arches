    ...
    update_refresh_tile_resource_relationship_function = """
        ...
        BEGIN
            ...
            FROM relationships r
                     left join resource_instances rifrom on resource_id = rifrom.resourceinstanceid
                     left join resource_instances rito on (r.relationship->>'resourceId')::uuid = rito.resourceinstanceid;
